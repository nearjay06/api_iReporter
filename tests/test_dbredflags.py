...
class TestEndpoints(unittest.TestCase):
    ...
    def test_get_all_redflag_records(self):
        self.test_client.post('/api/v2/redflags', content_type= 'application/json', data = json.dumps(self.redflag))
    ...
    def test_location_integer_error(self):
        ...
        response = self.test_client.post('/api/v2/redflags', content_type= 'application/json', data = json.dumps(self.redflag))
        self.assertEqual(400,response.status_code)
